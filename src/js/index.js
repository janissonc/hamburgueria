...
const spanCloseDate = document.getElementById("closed-restaurant");
const spanOpenDate = document.getElementById("open-restaurant");
...
//Fechar o modal do carrinho clicando em fechar
...
const isOpen = checkrestaurantOpen();
if(isOpen){
    spanDate.classList.add("bg-green-600");
    spanDate.classList.remove("bg-red-500");
    
    spanDate.firstElementChild.innerHTML = "Restaurante Aberto Seg á Dom - 18:00 as 22:00";
}else{
    spanDate.classList.remove("bg-green-600");
    spanDate.classList.add("bg-red-500");
    spanDate.firstElementChild.innerHTML = "Restaurante fechado no momento - Aberto de Seg á Dom - 18:00 as 22:00";
}